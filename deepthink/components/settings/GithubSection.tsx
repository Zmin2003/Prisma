...
const GithubSection = ({ isOpen }: { isOpen: boolean }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      fetch('https://api.github.com/repos/yeahhe365/DeepThink')
        .then(res => res.json())
        .then(data => {
  ...
  return (
    <div className="border-t border-slate-100 pt-6">
      <a 
        href="https://github.com/yeahhe365/DeepThink" 
        target="_blank" 
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-800">yeahhe365 / DeepThink</p>
