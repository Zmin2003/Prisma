...
const ProcessFlow = ({ appState, managerAnalysis, experts, synthesisThoughts, defaultExpanded = true, processStartTime, processEndTime }: ProcessFlowProps) => {
      ...
      <div className="relative space-y-2">
        ...
        {(isSynthesisActive || isComplete) && (
          <ProcessNode 
            ...
            onToggle={() => setIsExpanded(!isExpanded)}
          >
            <div className="text-sm text-slate-600 pl-2 space-y-2">
              {isSynthesisActive ? (
              ...
              {synthesisThoughts && (
                <div className="mt-2 pt-2 border-t border-slate-200">
                  <p className="text-[10px] text-slate-400 uppercase tracking-wider mb-1 font-medium">Synthesis Reasoning</p>
